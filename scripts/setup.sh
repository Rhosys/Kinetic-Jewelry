...
# END lyra android sdk"

add_to_profile() {
  local profile="$1"
  [ -f "$profile" ] || return 0
  if grep -q "BEGIN lyra android sdk" "$profile"; then
...
echo ""
echo "Next steps:"
echo "  scripts/emulator-create.sh  — Create the LyraAVD emulator"
