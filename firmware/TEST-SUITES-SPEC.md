...
| # | Name | Action | Assert |
|:--|:-----|:-------|:-------|
| 1 | **Advertises** | central scans | "KineticJewel" found with service UUID `6f73feae-5e0c-4193-a0f1-e2c96c808d06` |
| 2 | **Connects** | central connects | no error; GATT service discoverable |
| 3 | **Firmware version** | read char `6f73feae-...808d07` | value = `[0x01]` |
