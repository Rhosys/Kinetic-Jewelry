...
Runs automatically after a successful `build-release` on main. Uploads the signed AAB to the Google Play Internal Testing track for `ch.rhosys.lyra`.
...
| Binding | `attribute.project_path/rhosys/rapid/kinetic-jewelry` |
